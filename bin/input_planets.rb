...
# run from repo parent directory. Otherwise the data directory is off.
#   bin/input_planets.rb
# 
# Requires an active MongoDB connection with the default settings.
# See the "client" line if you need to change anything.
# Also, you need to install the mongo gem:
#   gem install mongo
